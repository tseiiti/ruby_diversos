...
# def precos(html)
# 	doc = Nokogiri::HTML(open(html))
# 	doc.css("div.price").each do |e|
# 		puts e.text if e.text.include?("R$")
# 		puts e.at_css("a") if e.at_css("a")
# 		puts "*************"
# 	end
# 	puts doc.css("div.price").count
# end
...
def executa(html)
	...
	articles.each do |article|
		# precos(@root + article.at_css("div.details").at_css("div").at_css("a")['href'])
...
7.times do |i|
	executa(@root + "/celulares/fichas-tecnicas_#{i+1}.html?o=2")
end
